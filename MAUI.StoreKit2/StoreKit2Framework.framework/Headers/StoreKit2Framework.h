...
@class PaymentSubscriptionStatus;
...
@class NSDate;
SWIFT_CLASS("_TtC18StoreKit2Framework25PaymentSubscriptionStatus") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface PaymentSubscriptionStatus : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull productId;
@property (nonatomic, readonly, copy) NSString * _Nonnull renewalState;
...
@property (nonatomic, readonly, copy) NSString * _Nullable willAutoRenewProductId;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly) BOOL isIntroOffer;
